...
Assumeutxo is a feature that allows fast bootstrapping of a validating YukiCoind
instance.
...
```
$ YukiCoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ YukiCoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
