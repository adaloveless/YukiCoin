...
This guide describes how to build YukiCoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run YukiCoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/YukiCoin/YukiCoin/blob/master/doc/descriptors.md).
...
There are many ways to configure YukiCoin Core. Here is an example that
