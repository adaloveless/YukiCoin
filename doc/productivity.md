...
```sh
cmake --build build --target YukiCoind YukiCoin-cli
cmake --build build --target YukiCoin-qt
cmake --build build --target bench_YukiCoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:YukiCoin/YukiCoin.git
```
