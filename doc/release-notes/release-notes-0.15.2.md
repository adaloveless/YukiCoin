YukiCoin Core version *0.15.2* is now available from:

  <https://YukiCoincore.org/bin/YukiCoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in YukiCoin-tx (TheBlueMatt)
