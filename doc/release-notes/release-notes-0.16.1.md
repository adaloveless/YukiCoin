YukiCoin Core version 0.16.1 is now available from:

  <https://YukiCoincore.org/bin/YukiCoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting YukiCoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure YukiCoind processes are cleaned up when tests end (sdaftuar)
