YukiCoin Core version 27.0 is now available from:

  <https://YukiCoincore.org/bin/YukiCoin-core-27.0/>
...
libYukiCoinconsensus
-------------------

- libYukiCoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libYukiCoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build YukiCoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of YukiCoin Core would
