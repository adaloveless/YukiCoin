YukiCoin Core version 0.9.4 is now available from:

  https://YukiCoin.org/bin/0.9.4/
...
this update is incompatible with the YukiCoin system and could lead to consensus
forks.

YukiCoin Core released binaries from https://YukiCoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~YukiCoin/+archive/ubuntu/YukiCoin
- A third-party or self-compiled YukiCoin Core

upgrade to YukiCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
