YukiCoin Core version 0.9.2.1 is now available from:

  https://YukiCoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 YKI to 0.01 YKI
...
- Fix "Start YukiCoin on system login"
