YukiCoin Core version 0.10.4 is now available from:

  <https://YukiCoin.org/bin/YukiCoin-core-0.10.4/>
...
- #6953 `43c2789` Split YukiCoin-tx into its own package
- #6953 `dfe0d4d` Include YukiCoin-tx binary on Debian/Ubuntu
