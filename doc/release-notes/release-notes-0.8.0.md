YukiCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/YukiCoin/files/YukiCoin/YukiCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the YukiCoin
...
New/changed settings (command-line or YukiCoin.conf file)
--------------------------------------------------------
