...
YukiCoin Core version 0.19.1 is now available from:

  <https://YukiCoincore.org/bin/YukiCoin-core-0.19.1/>
...
From YukiCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as YukiCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, YukiCoin Core does not yet change appearance when
...
- #17488 fix "YukiCoind already running" warnings on macOS (fanquake)
