YukiCoin Core version 0.13.2 is now available from:

  <https://YukiCoin.org/bin/YukiCoin-core-0.13.2/>
...
- #8908 `4a974b2` Update YukiCoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow YukiCoin-tx to create v2 transactions (btcdrak)
