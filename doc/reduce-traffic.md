...
By default, YukiCoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that YukiCoin's trustless model works best if you are
