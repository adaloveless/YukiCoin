...
**When configuring YukiCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring YukiCoin Core:
...
variables will be set when generating the YukiCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
