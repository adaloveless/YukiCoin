...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef YukiCoin_CHAINPARAMSSEEDS_H\n')
    g.write('#define YukiCoin_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the YukiCoin network\n')
    ...
    g.write('#endif // YukiCoin_CHAINPARAMSSEEDS_H\n')
