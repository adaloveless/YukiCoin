...
# Extract options
function __fish_YukiCoin_tx_get_options
...
# Extract commands
function __fish_YukiCoin_tx_get_commands
...
complete \
    --command YukiCoin-tx \
    --condition "not __fish_YukiCoin_seen_cmd (__fish_YukiCoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_YukiCoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command YukiCoin-tx \
    --arguments "(__fish_YukiCoin_tx_get_commands)" \
    --no-files
