...
complete --command YukiCoind --no-files

# Extract options
function __fish_YukiCoind_get_options
...
complete \
    --command YukiCoind \
    --arguments "(__fish_YukiCoind_get_options --nofiles)"
