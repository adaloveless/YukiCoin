...
complete --command YukiCoin-qt --no-files

# Extract options
function __fish_YukiCoinqt_get_options
...
complete \
    --command YukiCoin-qt \
    --arguments "(__fish_YukiCoinqt_get_options --nofiles)"
