...
(define* (make-YukiCoin-cross-toolchain target
                                       #:key
...
desirable for building YukiCoin Core release binaries."
...
;; failure; see https://github.com/YukiCoin/YukiCoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-YukiCoin-cross-toolchain target)))
