...
{
    BOOST_CHECK(TestSplitHost("www.YukiCoincore.org", "www.YukiCoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.YukiCoincore.org]", "www.YukiCoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.YukiCoincore.org:80", "www.YukiCoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.YukiCoincore.org]:80", "www.YukiCoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.YukiCoincore.org:65536", "www.YukiCoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.YukiCoincore.org:0", "www.YukiCoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.YukiCoincore.org:", "www.YukiCoincore.org:", 0, false));
}
