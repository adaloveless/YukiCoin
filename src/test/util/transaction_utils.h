// Copyright (c) 2019-2020 The YukiCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YukiCoin_TEST_UTIL_TRANSACTION_UTILS_H
#define YukiCoin_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // YukiCoin_TEST_UTIL_TRANSACTION_UTILS_H
