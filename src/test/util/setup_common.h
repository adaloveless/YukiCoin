// Copyright (c) 2015-present The YukiCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YukiCoin_TEST_UTIL_SETUP_COMMON_H
#define YukiCoin_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/YukiCoin/YukiCoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // YukiCoin_TEST_UTIL_SETUP_COMMON_H
