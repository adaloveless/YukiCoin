...
#ifndef YukiCoin_TEST_SCRIPTNUM10_H
#define YukiCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from YukiCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // YukiCoin_TEST_SCRIPTNUM10_H
