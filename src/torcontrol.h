// Copyright (c) 2015-2021 The YukiCoin Core developers
 ...
 */
#ifndef YukiCoin_TORCONTROL_H
#define YukiCoin_TORCONTROL_H
...
/****** YukiCoin specific TorController implementation ********/
