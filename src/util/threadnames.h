// Copyright (c) 2018-2019 The YukiCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YukiCoin_UTIL_THREADNAMES_H
#define YukiCoin_UTIL_THREADNAMES_H
...
#endif // YukiCoin_UTIL_THREADNAMES_H
