...
const std::string CURRENCY_UNIT = "UKI"; // One formatted unit
const std::string CURRENCY_ATOM = "yuki"; // One indivisible minimum value unit
...
enum class FeeEstimateMode {
    ...
    UKI_KVB,      //!< Use UKI/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::UKI_KVB) const;
