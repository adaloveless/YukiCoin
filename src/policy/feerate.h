...
#ifndef YukiCoin_POLICY_FEERATE_H
#define YukiCoin_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "YUKI"; // One formatted unit
const std::string CURRENCY_ATOM = "snow"; // One indivisible minimum value unit
...
enum class FeeEstimateMode {
    ...
    YUKI_KVB,     //!< Use YUKI/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::YUKI_KVB) const;
...
#endif // YukiCoin_POLICY_FEERATE_H
