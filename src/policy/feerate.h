...
const std::string CURRENCY_UNIT = "YKI"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    YKI_KVB,      //!< Use YKI/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::YKI_KVB) const;
