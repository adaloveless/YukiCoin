...
#ifndef YukiCoin_IPC_CAPNP_COMMON_TYPES_H
#define YukiCoin_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between YukiCoin processes.
...
//! Functions to serialize / deserialize common YukiCoin types.
namespace mp {
...
#endif // YukiCoin_IPC_CAPNP_COMMON_TYPES_H
