...
#ifndef YukiCoin_WALLET_TRANSACTION_H
#define YukiCoin_WALLET_TRANSACTION_H
...
public:
     ...
     * on this YukiCoin node, and set to 0 for transactions that were created
...
#endif // YukiCoin_WALLET_TRANSACTION_H
