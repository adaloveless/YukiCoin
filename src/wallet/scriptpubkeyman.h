...
#ifndef YukiCoin_WALLET_SCRIPTPUBKEYMAN_H
#define YukiCoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The YukiCoin Core wallet was originally a collection of unrelated private
...
#endif // YukiCoin_WALLET_SCRIPTPUBKEYMAN_H
