...
#ifndef YukiCoin_WALLET_WALLETUTIL_H
#define YukiCoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! YukiCoin from opening the wallet, thinking it was newly created, and
...
#endif // YukiCoin_WALLET_WALLETUTIL_H
