...
#ifndef YukiCoin_WALLET_WALLET_H
#define YukiCoin_WALLET_WALLET_H
...
public:
     ...
     * YukiCoin-wallet tool code or by wallet migration code. If this is called
...
#endif // YukiCoin_WALLET_WALLET_H
