...
// Copyright 2015 YukiCoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef YukiCoin_UNIVALUE_INCLUDE_UNIVALUE_H
#define YukiCoin_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // YukiCoin_UNIVALUE_INCLUDE_UNIVALUE_H
