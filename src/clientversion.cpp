...
// The <YukiCoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/YukiCoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure YukiCoin Core copyright is not removed by accident
    if (copyright_devs.find("YukiCoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The YukiCoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/YukiCoin/YukiCoin>";
