...
#ifndef YukiCoin_ARITH_UINT256_H
#define YukiCoin_ARITH_UINT256_H
...
public:
     ...
     *
     * YukiCoin only uses this "compact" format for encoding difficulty
...
#endif // YukiCoin_ARITH_UINT256_H
