...
#ifndef YukiCoin_COMMON_SIGNMESSAGE_H
#define YukiCoin_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's YukiCoin address, it must refer to a public key.
...
#endif // YukiCoin_COMMON_SIGNMESSAGE_H
