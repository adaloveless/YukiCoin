...
#ifndef YukiCoin_COMMON_ARGS_H
#define YukiCoin_COMMON_ARGS_H
...
extern const char * const YukiCoin_CONF_FILENAME;
extern const char * const YukiCoin_SETTINGS_FILENAME;
