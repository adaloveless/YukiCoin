...
/**
 * Build the YukiCoin genesis block.
 *
 * The genesis block uses Scrypt proof-of-work like Litecoin.
 * nBits: 0x1e0ffff0 (Litecoin-style initial difficulty)
 * 
 * To mine a new genesis block, run the genesis_miner utility in contrib/genesis/
 */
 ...
 */
/**
 * YukiCoin Main network - uses Scrypt proof-of-work
 */
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 840000; // 4 years at 2.5 min blocks (like Litecoin)
        // No script flag exceptions for new chain
        consensus.BIP34Height = 1; // Enforce from start
        consensus.BIP34Hash = uint256{};
        consensus.BIP65Height = 1;
        consensus.BIP66Height = 1;
        consensus.CSVHeight = 1;
        consensus.SegwitHeight = 1; // Enable SegWit from start
        consensus.MinBIP9WarningHeight = 0;
        // Scrypt PoW limit (Litecoin-style)
        ...
        // Taproot active from start
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 0;

        consensus.nMinimumChainWork = uint256{}; // Will be updated after launch
        consensus.defaultAssumeValid = uint256{}; // Will be updated after launch

        /**
         * YukiCoin unique message start bytes
         */
        pchMessageStart[0] = 0xfb;
        pchMessageStart[1] = 0xc0;
        pchMessageStart[2] = 0xb6;
        pchMessageStart[3] = 0xdb;
        nDefaultPort = 8834; // YukiCoin P2P port
...
public:
    CTestNetParams() {
        ...
        // YukiCoin testnet genesis - placeholder values
        genesis = CreateGenesisBlock(1734220800, 0, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update assertions after mining testnet genesis block

        vFixedSeeds.clear();
        vSeeds.clear();
        // No seeds for new testnet
...
public:
    CTestNet4Params() {
        ...
        // YukiCoin testnet4 genesis
        genesis = CreateGenesisBlock(1734220800, 0, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Mine testnet4 genesis and update
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        // YukiCoin signet genesis
        genesis = CreateGenesisBlock(1734220800, 0, 0x1e0377ae, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Mine signet genesis
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // Regtest uses easy difficulty for instant mining
        genesis = CreateGenesisBlock(1734220800, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // Note: Genesis assertions commented out - the hash will be different with new timestamp
        // Run the node once to get the actual genesis hash, then update these values
