...
#ifndef YukiCoin_RPC_PROTOCOL_H
#define YukiCoin_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in YukiCoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< YukiCoin is not connected
