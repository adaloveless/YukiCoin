...
#ifndef YukiCoin_RPC_UTIL_H
#define YukiCoin_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting YKI/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1YKI/kvB.
 */
