...
#ifndef YukiCoin_QT_YukiCoinUNITS_H
#define YukiCoin_QT_YukiCoinUNITS_H
...
/** YukiCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class YukiCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit YukiCoinUnits(QObject *parent);
