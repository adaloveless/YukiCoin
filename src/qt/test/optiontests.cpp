...
{
    // Test regression https://github.com/YukiCoin/YukiCoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/YukiCoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/YukiCoin-core/gui/pull/568.
    // With fListen=false in ~/.config/YukiCoin/YukiCoin-Qt.conf and all else left as default,
    // YukiCoin-qt should set both -listen and -listenonion to false and start successfully.
