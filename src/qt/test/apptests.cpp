...
//! Entry point for YukiCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &YukiCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for YukiCoinGUI tests.
void AppTests::guiTests(YukiCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &YukiCoinGUI::consoleShown, this, &AppTests::consoleTests);
