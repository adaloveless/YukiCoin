...
#ifndef YukiCoin_QT_OPTIONSMODEL_H
#define YukiCoin_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for YukiCoin client.
...
public:
    ...
    YukiCoinUnit getDisplayUnit() const { return m_display_YukiCoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSYKIontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    YukiCoinUnit m_display_YukiCoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(YukiCoinUnit unit);
...
#endif // YukiCoin_QT_OPTIONSMODEL_H
