...
#ifndef YukiCoin_QT_RECEIVECOINSDIALOG_H
#define YukiCoin_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of YukiCoins */
...
#endif // YukiCoin_QT_RECEIVECOINSDIALOG_H
