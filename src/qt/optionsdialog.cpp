      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->YukiCoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->YukiCoinAtStartup);
    ...
    ui->YukiCoinAtStartup->setToolTip(ui->YukiCoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->YukiCoinAtStartup->setText(ui->YukiCoinAtStartup->text().arg(CLIENT_NAME));

    ui->openYukiCoinConfButton->setToolTip(ui->openYukiCoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new YukiCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->YukiCoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSYKIontrols);
...
void OptionsDialog::on_openYukiCoinConfButton_clicked()
{
