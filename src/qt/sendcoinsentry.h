...
#ifndef YukiCoin_QT_SENDCOINSENTRY_H
#define YukiCoin_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending YukiCoins.
 */
...
#endif // YukiCoin_QT_SENDCOINSENTRY_H
