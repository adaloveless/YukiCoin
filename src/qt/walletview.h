...
#ifndef YukiCoin_QT_WALLETVIEW_H
#define YukiCoin_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a YukiCoin wallet, and offers access to
...
#endif // YukiCoin_QT_WALLETVIEW_H
