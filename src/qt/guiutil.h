...
#ifndef YukiCoin_QT_GUIUTIL_H
#define YukiCoin_QT_GUIUTIL_H
...
/** Utility functions used by the YukiCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "YukiCoin:" URI into recipient object, return true on successful parsing
