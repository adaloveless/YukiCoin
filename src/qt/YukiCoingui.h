...
#ifndef YukiCoin_QT_YukiCoinGUI_H
#define YukiCoin_QT_YukiCoinGUI_H
...
/**
  YukiCoin GUI main class. This class represents the main window of the YukiCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YukiCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit YukiCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~YukiCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a YukiCoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, YukiCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed YukiCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(YukiCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // YukiCoin_QT_YukiCoinGUI_H
