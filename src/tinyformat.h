...
#include <algorithm>
#include <attributes.h> // Added for YukiCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for YukiCoin Core
#include <util/string.h> // Added for YukiCoin Core
...
// Added for YukiCoin Core. Similar to std::runtime_format from C++26.
...
// Added for YukiCoin Core. Wrapper for checking format strings at compile time.
