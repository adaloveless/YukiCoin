...
//! @file
//! @brief Common init functions shared by YukiCoin-node, YukiCoin-wallet, etc.

#ifndef YukiCoin_INIT_COMMON_H
#define YukiCoin_INIT_COMMON_H
