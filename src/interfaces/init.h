...
#ifndef YukiCoin_INTERFACES_INIT_H
#define YukiCoin_INTERFACES_INIT_H
...
//! (YukiCoin-gui, YukiCoin-node, YukiCoin-wallet, YukiCoind, YukiCoin-qt) and each
...
#endif // YukiCoin_INTERFACES_INIT_H
