...
#ifndef YukiCoin_INTERFACES_NODE_H
#define YukiCoin_INTERFACES_NODE_H
...
//! Top-level interface for a YukiCoin node (YukiCoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or YukiCoin.conf.
...
#endif // YukiCoin_INTERFACES_NODE_H
