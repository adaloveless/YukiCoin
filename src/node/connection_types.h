...
#ifndef YukiCoin_NODE_CONNECTION_TYPES_H
#define YukiCoin_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/YukiCoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on YukiCoin’s Peer-to-Peer Network")
...
#endif // YukiCoin_NODE_CONNECTION_TYPES_H
