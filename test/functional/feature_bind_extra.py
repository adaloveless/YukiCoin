...
"""
Test starting YukiCoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that YukiCoind has bound on "::1" (for RPC) and "::" (for P2P).
