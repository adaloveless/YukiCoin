#!/usr/bin/env python3
# Copyright (c) 2020-present The YukiCoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The YukiCoind node closes feeler connections as soon as a version
...
class P2PAddConnections(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        # YukiCoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that YukiCoind sends its own version prior to processing
