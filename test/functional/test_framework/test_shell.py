...
class TestShell:
    """Wrapper Class for YukiCoinTestFramework.

    The TestShell class extends the YukiCoinTestFramework
    ...
    class __TestShell(YukiCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by YukiCoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # YukiCoinTestFramework instances are supposed to be constructed with the path
