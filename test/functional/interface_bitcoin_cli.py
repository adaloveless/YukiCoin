...
# The block reward of coinbaseoutput.nValue (50) YKI/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 YKI/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"YukiCoin-cli -h\" for help or \"YukiCoin-cli listwallets\" to see "
...
class TestYukiCoinCli(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `YukiCoin-cli getblockchaininfo`")
        ...
        # Prevent YukiCoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and YukiCoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and YukiCoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (YKI/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (YKI/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 YKI) to the default wallet.
            ...
            # Test YukiCoin-cli -generate with -rpcwallet in multiwallet mode.
