...
Verify that a YukiCoind node can use an external signer command.
...
class RPCSignerTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart YukiCoind with -signer=<cmd>',
