...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/YukiCoin/YukiCoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our YukiCoind node")
