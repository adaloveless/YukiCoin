...
class FullBlockTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure YukiCoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure YukiCoind isn't accepting b28
        ...
        # YukiCoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the YukiCoin code has custom code which does so);
