...
class TxnMallTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 YKI:
        ...
        # First: use raw transaction API to send 1240 YKI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 YKI coin each
        ...
        # Node0's balance should be starting balance, plus 50YKI for another
        ...
        # Node0's total balance should be starting balance, plus 100YKI for
