...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the YukiCoinTestFramework
    pass


class ExampleTest(YukiCoinTestFramework):
    # Each functional test is a subclass of the YukiCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        YukiCoinTestFramework class so other tests can use it."""
