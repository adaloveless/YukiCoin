...
By default, YukiCoind will dump mempool on shutdown and
...
class MempoolPersistTest(YukiCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent YukiCoind from writing mempool.dat to disk. Verify that `savemempool` fails")
