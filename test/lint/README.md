...
```sh
DOCKER_BUILDKIT=1 docker build -t YukiCoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/YukiCoin -it YukiCoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/YukiCoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/YukiCoin-core/leveldb-subtree.git (branch YukiCoin-fork)
* for `src/crypto/ctaes`: https://github.com/YukiCoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/YukiCoin-core/crc32c-subtree.git (branch YukiCoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/YukiCoin-core/secp256k1.git
```
