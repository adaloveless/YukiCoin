...
# Copyright 2016-2017 The YukiCoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for YukiCoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "YukiCoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./YukiCoin-util":
        execprog = os.getenv("YukiCoinUTIL", default=execprog)
    elif testObj["exec"] == "./YukiCoin-tx":
        execprog = os.getenv("YukiCoinTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, YukiCoin-tx
